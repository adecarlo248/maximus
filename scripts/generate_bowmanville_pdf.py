...
with open(enriched_file, newline="", encoding="utf-8") as f:
    for row in csv.DictReader(f):
        if "bowmanville" in row.get("Source City","").lower():
            agents.append(row)
...
<head>
<meta charset="utf-8">
<title>Bowmanville Expired Insurance Agents — April 2026</title>
<style>
...
<body>
<div class="header">
  <h1>Bowmanville — Expired &amp; Lapsed Insurance Agents</h1>
  <p>Source: FSRA Ontario Public Registry &nbsp;|&nbsp; Pulled: April 24, 2026 &nbsp;|&nbsp; Total: {len(agents)} agents</p>
</div>
<div class="summary-box">
  <strong>{expired_count} Fully Expired</strong> &nbsp;|&nbsp;
  <strong>{sponsor_count} No Sponsor</strong> &nbsp;|&nbsp;
...
out = os.path.join(SCRIPTS_DIR, "bowmanville_expired_agents.pdf")

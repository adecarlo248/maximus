...
with open(enriched_file, newline="", encoding="utf-8") as f:
    for row in csv.DictReader(f):
        if "port hope" in row.get("Source City","").lower():
            agents.append(row)
...
<head>
<meta charset="utf-8">
<title>Port Hope Expired Insurance Agents — April 2026</title>
<style>
...
<body>
<div class="header">
  <h1>Port Hope — Expired &amp; Lapsed Insurance Agents</h1>
...
out = os.path.join(SCRIPTS_DIR, "port_hope_expired_agents.pdf")
